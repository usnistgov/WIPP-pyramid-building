...
public:
     ...
     */
    BaseTileGeneratorFastImage(StitchingVectorParser *reader, BlendingMethod blendingMethod): grid(reader->getGrid()), directory(reader->getImageDirectoryPath()), tileWidth(
