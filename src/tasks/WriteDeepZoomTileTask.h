...
public:
    ...
    WriteDeepZoomTileTask(size_t numThreads, const std::string &_pathOut, const int nbPyramidLevel, const ImageDepth imageDepth) : htgs::ITask<Tile<T>, Tile<T>>(numThreads),
